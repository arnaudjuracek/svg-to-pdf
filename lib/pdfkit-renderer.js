...
const resolveInheritedProperties = require('./utils/svg-resolve-inherited')
...
module.exports = {
  ...
  image: (doc, el, { userUnit }) => {
    render(doc, el, { userUnit }, el => {
      ...
      try {
        doc.image(href, el.properties.x, el.properties.y, el.properties)
      } catch (error) {
